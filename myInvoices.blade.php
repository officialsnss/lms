                            ...
                            <div id="invoice_print" class="invoice_part_iner">
                                ...
                                <table class="table custom_table3 mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="black_color">{{__('student.Course name')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        @if(($enroll->price-$enroll->purchase_price)==0)
                                            <td>{{$enroll->price-$enroll->purchase_price}}</td>

                                        @else
                                            <td>{{getPriceFormat($enroll->price-$enroll->purchase_price)}}</td>
                                        @endif
                                    </tr>
                                    @if(hasTax())
                                        <tr>
                                            ...
                                            <td>{{getPriceFormat($enroll->tax)}}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <td></td>
