            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="breadcam_wrap">
                        <span>
                            {{@$frontendContent->quiz_page_title}}
                        </span>
                        <h3>
                            {{@$frontendContent->quiz_page_sub_title}}
                        </h3>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="Check_sidebar">
                                    <li>
                                        <label class="primary_checkbox d-flex">
                                            ...
                                            <span class="checkmark mr_15"></span>
                                            <span class="label_name">{{__('frontend.Paid Quiz')}}</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="primary_checkbox d-flex">
                                            ...
                                            <span class="checkmark mr_15"></span>
                                            <span class="label_name">{{__('frontend.Free Quiz')}}</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
